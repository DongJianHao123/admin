...
const OperateEmail = () => {
  ...
  return <div className="email-send-container">
    <Card title="发送邮件" bordered={false} style={{ width: 800 }}>
      ...
      >
        ...
        <ProFormTextArea
          ...
          allowClear
          addonAfter={<Excel2Data regex={EmailRegex} onChange={(e) => form.setFieldValue('emails', e.join(';'))} />}
        />
        <ProFormRadio.Group
          width="lg"
          name="type"
    ...
    {emailNum > 0 &&
      <Card title={`发送结果(${sendRes.length}/${emailNum})`} bordered={false} style={{ overflowY: 'scroll', width: 500 }} >
        <ProTable<SendRes>
